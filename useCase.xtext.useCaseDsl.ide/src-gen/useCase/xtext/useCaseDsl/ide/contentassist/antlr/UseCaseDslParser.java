...
public class UseCaseDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, UseCaseDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getUseCaseStepAccess().getGroup_3_6(), "rule__UseCaseStep__Group_3_6__0");
			builder.put(grammarAccess.getUseCaseStepAccess().getGroup_3_6_0(), "rule__UseCaseStep__Group_3_6_0__0");
			...
			builder.put(grammarAccess.getUseCaseStepAccess().getNameAssignment_0_0(), "rule__UseCaseStep__NameAssignment_0_0");
			builder.put(grammarAccess.getUseCaseStepAccess().getIncludeAssignment_0_3(), "rule__UseCaseStep__IncludeAssignment_0_3");
			...
			builder.put(grammarAccess.getUseCaseStepAccess().getSentenceAssignment_2_4(), "rule__UseCaseStep__SentenceAssignment_2_4");
			builder.put(grammarAccess.getUseCaseStepAccess().getNameAssignment_3_1(), "rule__UseCaseStep__NameAssignment_3_1");
			builder.put(grammarAccess.getUseCaseStepAccess().getRepeatingConditionAssignment_3_4(), "rule__UseCaseStep__RepeatingConditionAssignment_3_4");
			builder.put(grammarAccess.getUseCaseStepAccess().getParentAssignment_3_6_0_0(), "rule__UseCaseStep__ParentAssignment_3_6_0_0");
			builder.put(grammarAccess.getUseCaseStepAccess().getRepeatflowAssignment_3_6_1(), "rule__UseCaseStep__RepeatflowAssignment_3_6_1");
