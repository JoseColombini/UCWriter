...
public class UseCaseDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, UseCaseDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getUseCaseAccess().getPreconditionAssignment_5_0(), "rule__UseCase__PreconditionAssignment_5_0");
			builder.put(grammarAccess.getUseCaseAccess().getPostconditionAssignment_6_0(), "rule__UseCase__PostconditionAssignment_6_0");
			builder.put(grammarAccess.getUseCaseAccess().getMainflowAssignment_7(), "rule__UseCase__MainflowAssignment_7");
			builder.put(grammarAccess.getUseCaseAccess().getStepsAssignment_10(), "rule__UseCase__StepsAssignment_10");
			builder.put(grammarAccess.getUseCaseAccess().getDeclareofflowAssignment_12_0(), "rule__UseCase__DeclareofflowAssignment_12_0");
