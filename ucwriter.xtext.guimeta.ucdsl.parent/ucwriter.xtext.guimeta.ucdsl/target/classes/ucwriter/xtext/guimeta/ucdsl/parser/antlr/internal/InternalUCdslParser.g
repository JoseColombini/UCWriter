...
// Entry rule entryRuleExtensioCondition
entryRuleExtensioCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getExtensioConditionRule()); }
	iv_ruleExtensioCondition=ruleExtensioCondition
	{ $current=$iv_ruleExtensioCondition.current; }
	EOF;

// Rule ExtensioCondition
ruleExtensioCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleRepeatingCondition
entryRuleRepeatingCondition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRepeatingConditionRule()); }
	iv_ruleRepeatingCondition=ruleRepeatingCondition
	{ $current=$iv_ruleRepeatingCondition.current; }
	EOF;

// Rule RepeatingCondition
ruleRepeatingCondition returns [EObject current=null]
@init {
	enterRule();
}
@after {
