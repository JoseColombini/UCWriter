...
public class UCdslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, UCdslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExtensionAccess().getAlternatives_7_0_4(), "rule__Extension__Alternatives_7_0_4");
			...
			builder.put(grammarAccess.getExtensionAccess().getResumeAtAssignment_7_0_4_1(), "rule__Extension__ResumeAtAssignment_7_0_4_1");
