...
public class UseCaseDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, UseCaseDslGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getStepAccess().getTypeAlternatives_1_0(), "rule__Step__TypeAlternatives_1_0");
			...
			builder.put(grammarAccess.getStepAccess().getTypeAssignment_1(), "rule__Step__TypeAssignment_1");
			builder.put(grammarAccess.getStepAccess().getSentenceAssignment_2(), "rule__Step__SentenceAssignment_2");
			builder.put(grammarAccess.getUserStepAccess().getNameAssignment_1(), "rule__UserStep__NameAssignment_1");
			builder.put(grammarAccess.getSystemStepAccess().getNameAssignment_1(), "rule__SystemStep__NameAssignment_1");
		}
	}
