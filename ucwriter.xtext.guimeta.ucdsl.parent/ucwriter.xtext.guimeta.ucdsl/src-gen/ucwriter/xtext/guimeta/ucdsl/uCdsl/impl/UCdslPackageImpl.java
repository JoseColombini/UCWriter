...
import ucwriter.xtext.guimeta.ucdsl.uCdsl.UCdslFactory;
 ...
 * @generated
 */
public class UCdslPackageImpl extends EPackageImpl implements UCdslPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see ucwriter.xtext.guimeta.ucdsl.uCdsl.UCdslPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private UCdslPackageImpl()
  {
    super(eNS_URI, UCdslFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link UCdslPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static UCdslPackage init()
  {
    if (isInited) return (UCdslPackage)EPackage.Registry.INSTANCE.getEPackage(UCdslPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredUCdslPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    UCdslPackageImpl theUCdslPackage = registeredUCdslPackage instanceof UCdslPackageImpl ? (UCdslPackageImpl)registeredUCdslPackage : new UCdslPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theUCdslPackage.createPackageContents();

    // Initialize created meta-data
    theUCdslPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theUCdslPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(UCdslPackage.eNS_URI, theUCdslPackage);
    return theUCdslPackage;
  }
   ...
   */
  @Override
  public EReference getStep_Reference()
  {
   ...
   */
  @Override
  public EClass getExtensioCondition()
  {
    return extensioConditionEClass;
  }
   ...
   */
  @Override
  public EAttribute getExtensioCondition_Condition()
  {
    return (EAttribute)extensioConditionEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getRepeatingStep_Steps()
  {
   ...
   */
  @Override
  public UCdslFactory getUCdslFactory()
  {
    return (UCdslFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(stepEClass, STEP__REFERENCE);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getExtension_Condition(), this.getExtensioCondition(), null, "condition", null, 0, 1, Extension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getStep_Reference(), this.getUseCase(), null, "reference", null, 0, 1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(useCaseStepEClass, UseCaseStep.class, "UseCaseStep", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getUseCaseStep_Parent(), this.getRepeatingStep(), null, "parent", null, 0, 1, UseCaseStep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
